...
const Feedback = () => {
  return (
    <>
      <div className="bg-secondary-gradient relative  px-4 mx-auto">
      ...
      <div className="feedback-bg bg-[#1B2029]  lg:w-[90%] lg:h-[30rem] md:h-[24rem] h-[17rem] mb-[10rem]  w-[100%] mx-auto relative mt-[5rem]">
        <div className="flex lg:px-[8rem] px-8  lg:py-[5rem] py-8 text-center justify-center items-center gap-6">
          <div>
            <Image
              src={leftQuote}
              alt="Quote"
              className="w-[20px] h-[20px] lg:w-[100%] lg:h-[100%] relative lg:top-[-4rem] top-[-2rem]"
            />
          </div>
      ...
      <div className="lg:text-[48px] text-[30px] flex text-center justify-center relative lg:top-[-20rem] top-[-16rem] lg:gap-[55%] gap-[45%]">
        <p className="">
          {" "}
          <GoArrowLeft />
        </p>
